...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    Args:
        name: The name of the policy. Supported names are "tdmpc", "diffusion", "act","actdist",
    ...
    if name == "tdmpc":
        ...
        from lerobot.policies.actdist.modeling_actdist import ACTDISTPolicy

        return ACTDISTPolicy
    elif name == "vqbet":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    Args:
        policy_type: The type of the policy. Supported types include "tdmpc",
                     "diffusion", "act", "actdist" ,"vqbet", "pi0", "pi05", "sac", "smolvla",
                     "reward_classifier".
    ...
    elif policy_type == "actdist":
        return ACTDISTConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, ACTDISTConfig):
        from lerobot.policies.actdist.processor_actdist import make_actdist_pre_post_processors

        processors = make_actdist_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
